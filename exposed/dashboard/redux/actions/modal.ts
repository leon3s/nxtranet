...
const ON_MODAL_FORM_ERROR = defineAction('ON_MODAL_FORM_ERROR');
...
const OPEN_MODAL_CONFIRM = defineAction('OPEN_MODAL_CONFIRM');
...
const CLOSE_MODAL_CONFIRM = defineAction('CLOSE_MODAL_CONFIRM');
